        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-10 animate-fade-in-up">
            ...
            <p className="text-lg mb-8" style={{ color: '#B8B2A8' }}>
              {savedPetImage 
                ? "You have 2 hours to create unlimited royal portraits! Upload your pet photo to get started."
                : "Upload your pet photo and create as many royal portraits as you want for the next 2 hours!"}
            </p>
            ...
            >
              ...
              {savedPetImage ? "Continue Creating" : "Start Creating"}
            </Link>
    ...
    <div className="min-h-screen bg-renaissance py-12 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div 
            className="relative mx-auto mb-6 rounded-lg overflow-hidden"
                ...
                <div 
                  ...
                  style={{
                    ...
                    ...(selectedCanvas === "16x16" ? {
                      ...
                      // 12x12: Slightly zoomed to fill canvas better
